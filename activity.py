...
class ActivityList:
    ...
    def initialize_me(self):
        ...
        with open('Activities.json', 'r') as f:
            data = json.load(f)
            activity_list = ActivityList(
                activities = get_activities_from_json(data)
            )        
    def get_activities_from_json(self, data):
        return_list = []
        for activity in data:
            return_list.append(Activity(activity['name'], 
            get_time_entries_from_json(activity)))
        return return_list
    ...
    def serialize(self):
        return {
            'activities': self.activity_to_json()
        }
...
class Activity:
    ...
    def serialize(self):
        return {
            'name' : self.name,
            'time_entries' : self.make_time_entrie_to_json()           
        }
    
    def make_time_entrie_to_json(self):
        time_list = []
